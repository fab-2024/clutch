...
const styles = StyleSheet.create({
  ...
  back: { width: 44, minHeight: 44, alignItems: 'center', justifyContent: 'center', borderRightWidth: 1, borderRightColor: '#1B242B' },
  backGlyph: { color: '#C5CDD3', fontSize: 22, lineHeight: 24, fontWeight: '500' },
  tabs: { flex: 1, minWidth: 0, flexDirection: 'row' },
  tab: { position: 'relative', flex: 1, minWidth: 0, minHeight: 44, paddingHorizontal: 3, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5, borderRightWidth: 1, borderRightColor: '#151D23' },
  ...
  count: { width: 52, minHeight: 44, alignItems: 'center', justifyContent: 'center', borderLeftWidth: 1, borderLeftColor: '#1B242B' },
