...
const styles = StyleSheet.create({
  ...
  back: { minHeight: 38, alignSelf: 'flex-start', paddingHorizontal: 12, alignItems: 'center', justifyContent: 'center', borderRadius: 13, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E' },
  ...
  section: { flexDirection: 'row', gap: 14, paddingVertical: 22, borderTopWidth: 1, borderTopColor: '#30414E' },
