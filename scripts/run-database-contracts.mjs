...
const contractFiles = [
  ...
  'supabase/tests/daily_bonus_manual_status.sql',
  'supabase/tests/call_streak_retention_p1.sql',
  'supabase/tests/call_streak_volt_rewards.sql',
  ...
  'supabase/tests/original_packs_wave_two.sql',
  ...
  'supabase/tests/cosmetic_packs_store.sql',
  'supabase/tests/match_result_reliability.sql',
  'supabase/tests/pandascore_sync_contract.sql',
  'supabase/tests/historical_elo_call_opening.sql',
  'supabase/tests/selected_teams_match_feed.sql',
