...
export const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.volt, fontSize: 11, lineHeight: 14, fontWeight: '900', letterSpacing: 1.5 },
  ...
  retry: { color: colors.volt, fontSize: 11, lineHeight: 14, fontWeight: '900', letterSpacing: 1 },
  hero: { position: 'relative', overflow: 'hidden', borderRadius: 28, borderWidth: 1, backgroundColor: '#111A22', padding: 18, gap: 18 },
  ...
  identityEyebrow: { color: colors.textMuted, fontSize: 11, lineHeight: 14, fontWeight: '900', letterSpacing: 1.2 },
  factionName: { marginTop: 2, color: colors.text, fontSize: 20, fontWeight: '900', letterSpacing: -0.5 },
  factionMeta: { marginTop: 3, color: colors.textMuted, fontSize: 11, lineHeight: 14, fontWeight: '700', letterSpacing: 0.5 },
  ...
  teamBadgeText: { color: '#FFFFFF', fontSize: 11, fontWeight: '900', letterSpacing: 0.2 },
  teamBadgeTextLarge: { fontSize: 13 },
  signalRow: { zIndex: 2, minHeight: 34, borderRadius: 17, paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border },
  signalDot: { width: 7, height: 7, borderRadius: 4 },
  signalText: { color: colors.text, fontSize: 11, lineHeight: 14, fontWeight: '900', letterSpacing: 0.8 },
  signalRemaining: { flex: 1, color: colors.textMuted, fontSize: 11, lineHeight: 14, textAlign: 'right' },
  ...
  relicCharm: { position: 'absolute', right: 29, top: 56, width: 30, height: 30, borderRadius: 15, alignItems: 'center', justifyContent: 'center', borderWidth: 1, backgroundColor: '#0B1218' },
  relicCharmText: { fontSize: 8, fontWeight: '900' },
  relicLabel: { marginTop: 14, alignItems: 'center', gap: 2 },
  formCode: { color: colors.textMuted, fontSize: 11, lineHeight: 14, fontWeight: '900', letterSpacing: 1.5 },
  ...
  chargeEyebrow: { color: colors.textMuted, fontSize: 11, lineHeight: 14, fontWeight: '900', letterSpacing: 1.1 },
  ...
  nextMutation: { zIndex: 2, flexDirection: 'row', alignItems: 'center', gap: 11, padding: 12, borderRadius: radius.md, backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border },
  nextMutationMark: { width: 40, height: 46, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border },
  nextMutationCode: { color: colors.textMuted, fontSize: 12, fontWeight: '900' },
  nextMutationCopy: { flex: 1, minWidth: 0 },
  nextMutationEyebrow: { color: colors.textMuted, fontSize: 11, lineHeight: 14, fontWeight: '900', letterSpacing: 1 },
  nextMutationTitle: { marginTop: 2, color: colors.text, fontSize: 14, fontWeight: '900' },
  nextMutationDetail: { marginTop: 2, color: colors.textMuted, fontSize: 11, lineHeight: 14 },
  rewardPill: { alignItems: 'flex-end' },
  rewardValue: { color: colors.volt, fontSize: 13, fontWeight: '900' },
  rewardUnit: { color: colors.textMuted, fontSize: 11, lineHeight: 14, fontWeight: '900', letterSpacing: 1 },
  visitorNotice: { flexDirection: 'row', alignItems: 'flex-start', gap: 12, padding: 15, borderRadius: radius.lg, backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border },
  visitorIcon: { width: 38, height: 38, borderRadius: 19, alignItems: 'center', justifyContent: 'center', backgroundColor: '#111A22' },
  ...
  sectionEyebrow: { color: colors.textMuted, fontSize: 11, lineHeight: 14, fontWeight: '900', letterSpacing: 1.3 },
  sectionTitle: { marginTop: 4, color: colors.text, fontSize: 20, lineHeight: 24, fontWeight: '900', letterSpacing: -0.5 },
  sectionMeta: { color: colors.textMuted, fontSize: 11, lineHeight: 14, fontWeight: '900', letterSpacing: 0.8 },
  rankingCard: { overflow: 'hidden', borderRadius: radius.lg, backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border },
  rankRow: { minHeight: 66, flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 12, borderBottomWidth: 1, borderBottomColor: '#30414E' },
  rankRowFocused: { backgroundColor: '#111A22' },
  ...
  mePillText: { color: colors.volt, fontSize: 11, lineHeight: 14, fontWeight: '900', letterSpacing: 0.5 },
  rankDetail: { marginTop: 3, color: colors.textMuted, fontSize: 11, lineHeight: 14 },
  ...
  speedHint: { marginTop: 3, color: colors.textMuted, fontSize: 11, lineHeight: 14, fontWeight: '800' },
  impactCard: { padding: 15, borderRadius: radius.lg, backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border, gap: 14 },
  impactStats: { flexDirection: 'row', gap: 8 },
  impactStat: { flex: 1, minWidth: 0, padding: 11, borderRadius: radius.md, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E' },
  impactStatLabel: { color: colors.textMuted, fontSize: 11, lineHeight: 14, fontWeight: '900', letterSpacing: 0.8 },
  ...
  topLabel: { color: colors.textMuted, fontSize: 11, lineHeight: 14, fontWeight: '900', letterSpacing: 1 },
  contributorRow: { minHeight: 48, flexDirection: 'row', alignItems: 'center', gap: 9 },
  contributorRank: { width: 24, color: colors.textMuted, fontSize: 11, fontWeight: '900' },
  ...
  contributorInitials: { color: colors.text, fontSize: 11, fontWeight: '900' },
  contributorCopy: { flex: 1, minWidth: 0 },
  contributorName: { color: colors.text, fontSize: 11, fontWeight: '800' },
  contributorDetail: { marginTop: 2, color: colors.textMuted, fontSize: 11, lineHeight: 14 },
  youBadge: { paddingHorizontal: 7, paddingVertical: 4, borderRadius: 999, backgroundColor: '#222A13' },
  youBadgeText: { color: colors.volt, fontSize: 11, lineHeight: 14, fontWeight: '900' },
  inlineEmpty: { color: colors.textMuted, fontSize: 11, lineHeight: 16 },
  archiveCard: { overflow: 'hidden', borderRadius: radius.lg, backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border },
  archiveRow: { minHeight: 64, flexDirection: 'row', alignItems: 'center', gap: 11, paddingHorizontal: 13, borderBottomWidth: 1, borderBottomColor: '#30414E' },
  archiveMark: { width: 36, height: 36, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border },
  archiveMarkOrigin: { backgroundColor: '#222A13', borderColor: '#3B4820' },
  archiveCode: { color: colors.textMuted, fontSize: 11, fontWeight: '900' },
  ...
  archiveDetail: { marginTop: 3, color: colors.textMuted, fontSize: 11, lineHeight: 14 },
  archiveReward: { color: colors.volt, fontSize: 11, fontWeight: '900' },
  ...
  formCard: { width: 126, minHeight: 146, padding: 13, borderRadius: radius.lg, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E' },
  formCardUnlocked: { backgroundColor: '#111A22', borderColor: '#30414E' },
  ...
  formCardThreshold: { marginTop: 4, color: colors.textMuted, fontSize: 11, lineHeight: 14, fontWeight: '800' },
  formState: { marginTop: 'auto', alignSelf: 'flex-start', paddingHorizontal: 7, paddingVertical: 4, borderRadius: 999, backgroundColor: '#111A22' },
  formStateUnlocked: { backgroundColor: '#222A13' },
  formStateText: { color: colors.textMuted, fontSize: 11, lineHeight: 14, fontWeight: '900', letterSpacing: 0.6 },
  ...
  emptyMark: { width: 54, height: 54, borderRadius: 27, alignItems: 'center', justifyContent: 'center', backgroundColor: '#111A22' },
  ...
  skeleton: { minHeight: 460, padding: 18, borderRadius: 28, backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border, gap: 16 },
