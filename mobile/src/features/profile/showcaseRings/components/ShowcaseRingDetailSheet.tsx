...
const styles = StyleSheet.create({
  ...
  sheet: { width: '100%', maxWidth: layout.contentMaxWidth, maxHeight: '94%', alignSelf: 'center', overflow: 'hidden', borderTopLeftRadius: 31, borderTopRightRadius: 31, backgroundColor: '#090E13', borderWidth: 1 },
  ...
  close: { width: 40, height: 40, alignItems: 'center', justifyContent: 'center', borderRadius: 13, backgroundColor: '#151B21', borderWidth: 1, borderColor: '#303A43' },
  closeText: { color: colors.text, fontSize: 24, lineHeight: 25 },
  visual: { position: 'relative', height: 260, overflow: 'hidden', alignItems: 'center', justifyContent: 'center', borderRadius: 22, backgroundColor: '#05080B', borderWidth: 1, borderColor: '#202A32' },
  ...
  stageDot: { flex: 1, height: 6, borderRadius: 3, backgroundColor: '#172029', borderWidth: 1, borderColor: '#35414B' },
  ...
  track: { height: 7, overflow: 'hidden', borderRadius: 4, backgroundColor: '#202A32' },
  trackFill: { height: '100%', borderRadius: 4 },
  condition: { padding: 12, borderRadius: 16, backgroundColor: '#070B0F', borderWidth: 1, borderColor: '#222C35' },
  ...
  actionEquipped: { backgroundColor: '#111820', borderWidth: 1, borderColor: '#43515C' },
  actionLocked: { backgroundColor: '#11171D', borderWidth: 1, borderColor: '#29343D' },
