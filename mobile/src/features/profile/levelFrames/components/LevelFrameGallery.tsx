...
const styles = StyleSheet.create({
  root: { gap: 15 },
  equippedHero: { position: 'relative', overflow: 'hidden', minHeight: 154, marginHorizontal: spacing.md, padding: 15, flexDirection: 'row', alignItems: 'center', gap: 13, borderRadius: 24, backgroundColor: '#090E13', borderWidth: 1, borderColor: '#31404A' },
  ...
  signalBoard: { marginHorizontal: spacing.md, padding: 15, gap: 11, overflow: 'hidden', borderRadius: 24, backgroundColor: '#081015', borderWidth: 1, borderColor: '#2B4650' },
  ...
  includedPill: { flexShrink: 0, minHeight: 27, paddingHorizontal: 7, alignItems: 'center', justifyContent: 'center', borderRadius: 14, backgroundColor: '#18200E', borderWidth: 1, borderColor: '#566424' },
  includedPillText: { ...typography.label, color: colors.volt, fontSize: 6.5, letterSpacing: .15 },
  signalText: { ...typography.caption, maxWidth: 430, color: '#919DA6' },
  evolutionTrack: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  evolutionStep: { flexBasis: '30%', flexGrow: 1, minHeight: 110, paddingVertical: 7, alignItems: 'center', borderRadius: 15, backgroundColor: '#05090C', borderWidth: 1, borderColor: '#202B32' },
  evolutionLevel: { ...typography.label, marginTop: 1, color: '#E4E9EB', fontSize: 8 },
  evolutionStage: { ...typography.eyebrow, marginTop: 2, color: '#687781', fontSize: 6.5 },
  ...
  card: { position: 'relative', width: '48%', minHeight: 338, padding: 10, borderRadius: 21, backgroundColor: '#090E13', borderWidth: 1, borderColor: '#26313A' },
  artwork: { position: 'relative', height: 137, alignItems: 'center', justifyContent: 'center', overflow: 'hidden', borderRadius: 16, backgroundColor: '#040709' },
  cardGlow: { position: 'absolute', width: 92, height: 92, borderRadius: 46, opacity: .1, boxShadow: '0 0 30px rgba(49,215,226,.13)' },
  equippedPill: { position: 'absolute', top: 7, right: 7, minHeight: 22, paddingHorizontal: 7, alignItems: 'center', justifyContent: 'center', borderRadius: 11, backgroundColor: colors.volt },
  equippedPillText: { ...typography.label, color: '#080A0C', fontSize: 7 },
  cardTopline: { marginTop: 9, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 5 },
  rarity: { ...typography.eyebrow, flex: 1, fontSize: 7.5, letterSpacing: .4 },
  state: { ...typography.label, color: '#6F7B84', fontSize: 6.5 },
  name: { ...typography.bodyStrong, minHeight: 38, marginTop: 5, color: colors.text },
  description: { ...typography.caption, minHeight: 44, marginTop: 2, color: colors.textMuted, fontSize: 8.5, lineHeight: 11 },
  priceRow: { minHeight: 25, marginTop: 5, flexDirection: 'row', alignItems: 'center', gap: 5 },
  sourceDot: { fontSize: 8 },
  price: { ...typography.label, color: '#D9DFE2', fontSize: 7.5 },
  action: { minHeight: 40, marginTop: 'auto', alignItems: 'center', justifyContent: 'center', borderRadius: 11, backgroundColor: colors.volt },
  actionEquipped: { backgroundColor: '#16200E', borderWidth: 1, borderColor: '#53621F' },
  actionDisabled: { backgroundColor: '#11171C', borderWidth: 1, borderColor: '#29333B' },
  actionText: { ...typography.action, color: '#080A0C', fontSize: 8.5 },
  actionTextMuted: { color: '#72808A' },
  shopState: { minHeight: 40, marginTop: 'auto', alignItems: 'center', justifyContent: 'center', borderRadius: 11, backgroundColor: '#10161B', borderWidth: 1, borderColor: '#28333B' },
  shopStateOwned: { backgroundColor: '#151D0E', borderColor: '#4D5A20' },
  shopStateText: { ...typography.label, color: '#74808A', fontSize: 7.5, textAlign: 'center' },
