...
const PREVIEW_RECAP: Record<string, unknown> = {
  ...
  badges_accomplissement_obtenus: [
    ...
    { id: 'versatile', obtenu_le: '2026-06-07T12:00:00.000Z', saison_id: 'preview-season' },
...
export const PREVIEW_PROFILE: ProfileData = {
  ...
  pinnedBadges: resolveBadgeSelection(['versatile', 'countercurrent', 'first_signal'], PREVIEW_BADGES, 4),
  ...
  cosmetics: {
    ...
    showcase: {
      ...
      supports: { id: 'supports_gallery', slot: 'vitrine_supports', level: 1, name: 'Classique', description: '', rarity: 'commun', styleKey: 'cabinet-classique', accent: '#31D7E2' },
