...
import type { TeamPackDefinition, TeamPackItemDefinition } from './packs/types';
...
export const SANG_DES_TITANS_PACK = defineOriginalPack({
  ...
  description: 'Huit cosmétiques originaux forgés pour les gardiens d’un pacte titanesque.',
  accent: TITAN_BRONZE,
  price: 1200,
  ...
  items: [
    ...
    },
    {
      ...
      image: require('../../../assets/shop/front-facing/sang-des-titans-oath-armor.png'),
    },
    {
      slug: 'eclipse-axe',
      ...
      accent: '#55D7DF',
      image: require('../../../assets/shop/front-facing/sang-des-titans-eclipse-axe.png'),
    },
    {
      slug: 'pact-banner',
    ...
    },
    {
      ...
      image: require('../../../assets/shop/front-facing/sang-des-titans-three-voices-totem.png'),
    },
    {
...
export const CHUTE_LIBRE_PACK = defineOriginalPack({
  ...
  description: 'Huit cosmétiques originaux pour les éclaireurs qui vivent au bord du vide.',
  ...
  items: [
    ...
    },
    {
      ...
      image: require('../../../assets/shop/front-facing/chute-libre-falcon-jetpack.png'),
    },
    {
      slug: 'loot-capsule',
      name: 'Capsule de Butin',
      description: 'Une capsule blindée qui protège les trouvailles ramenées des sommets.',
      image: require('../../../assets/shop/front-facing/chute-libre-loot-capsule.png'),
    },
    {
      slug: 'ascent-banner',
    ...
    },
    {
      ...
      image: require('../../../assets/shop/front-facing/chute-libre-summit-beacon.png'),
    },
    {
      slug: 'scout-badge',
...
export const SERMENT_DU_GIVRE_PACK = defineOriginalPack({
  ...
  description: 'Huit cosmétiques originaux gardés par le dragon des cimes éternelles.',
  accent: FROST_BLUE,
  price: 1200,
  ...
  items: [
    ...
    },
    {
      ...
      image: require('../../../assets/shop/front-facing/serment-du-givre-veyr-dragon.png'),
    },
    {
      slug: 'snow-compass',
      name: 'Boussole des Neiges',
      description: 'Une boussole d’expédition dont l’aiguille pointe vers le cristal du Givre.',
      image: require('../../../assets/shop/front-facing/serment-du-givre-snow-compass.png'),
    },
    {
      slug: 'oath-banner',
      name: 'Bannière du Serment',
      description: 'Une bannière bleu nuit portant le cristal ailé des veilleurs.',
      image: require('../../../assets/shop/front-facing/serment-du-givre-oath-banner.png'),
    },
    {
      slug: 'summit-egg',
      name: 'Œuf des Cimes',
      description: 'Un cristal ancestral protégé par un berceau de roche gelée.',
      image: require('../../../assets/shop/front-facing/serment-du-givre-summit-egg.png'),
    },
    {
      slug: 'watcher-badge',
      name: 'Badge Veilleur',
...
export const CONCLAVE_ARCANIQUE_PACK = defineOriginalPack({
  ...
  subtitle: 'BRUMOUSSE',
  description: 'Huit cosmétiques originaux où la pierre claire rencontre la magie florale.',
  ...
  items: [
    ...
    },
    {
      ...
      image: require('../../../assets/shop/front-facing/conclave-arcanique-brumousse.png'),
    },
    {
      slug: 'conclave-seal',
      name: 'Sceau du Conclave',
      description: 'Un cristal violet protégé par deux rameaux d’or arcanique.',
      image: require('../../../assets/shop/front-facing/conclave-arcanique-conclave-seal.png'),
    },
    {
      slug: 'bloom-banner',
      ...
      accent: '#98AA72',
      image: require('../../../assets/shop/front-facing/conclave-arcanique-bloom-banner.png'),
    },
    {
      slug: 'bud-totem',
      name: 'Totem Bourgeon',
      description: 'Une pousse torsadée protège un cristal prêt à éclore.',
      image: require('../../../assets/shop/front-facing/conclave-arcanique-bud-totem.png'),
    },
    {
      slug: 'guardian-badge',
      name: 'Badge Gardien',
...
export const TURBO_ARENA_PACK = defineOriginalPack({
  ...
  description: 'Huit cosmétiques originaux pour transformer la Vitrine en arène suralimentée.',
  accent: TURBO_ORANGE,
  price: 1200,
  ...
  items: [
    ...
    },
    {
      ...
      image: require('../../../assets/shop/front-facing/turbo-arena-comet-car.png'),
    },
    {
      slug: 'orbital-ball',
      name: 'Ballon Orbital',
      ...
      accent: '#4DA8FF',
      image: require('../../../assets/shop/front-facing/turbo-arena-orbital-ball.png'),
    },
    {
    ...
    },
    {
      ...
      image: require('../../../assets/shop/front-facing/turbo-arena-aerial-trophy.png'),
    },
    {
      slug: 'striker-badge',
      name: 'Badge Striker',
...
export const DERNIER_ROUND_PACK = defineOriginalPack({
  ...
  description: 'Huit cosmétiques originaux pour une escouade qui joue chaque round jusqu’au bout.',
  ...
  items: [
    ...
    },
    {
      ...
      image: require('../../../assets/shop/front-facing/dernier-round-sentinel-helmet.png'),
    },
    {
      slug: 'vector-carbine',
      name: 'Carabine Vector',
      description: 'Une carabine compacte rouge et graphite montée sur son présentoir blindé.',
      image: require('../../../assets/shop/front-facing/dernier-round-vector-carbine.png'),
    },
    {
      slug: 'squad-banner',
    ...
    },
    {
      ...
      accent: '#7FE8DB',
      image: require('../../../assets/shop/front-facing/dernier-round-scout-drone.png'),
    },
    {
      slug: 'operator-badge',
