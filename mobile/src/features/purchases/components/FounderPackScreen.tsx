...
const styles = StyleSheet.create({
  ...
  back: { minWidth: 72, height: 40, paddingHorizontal: 10, alignItems: 'center', justifyContent: 'center', borderRadius: 13, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E' },
  ...
  founderSeal: { zIndex: 2, width: 162, height: 162, padding: 5, alignItems: 'center', justifyContent: 'center', borderRadius: 53, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#80632F', transform: [{ rotate: '-5deg' }], boxShadow: '0 24px 46px rgba(0,0,0,.52)' },
  ...
  loading: { minHeight: 270, marginHorizontal: spacing.md, alignItems: 'center', justifyContent: 'center', gap: 9, borderRadius: 26, backgroundColor: '#0B1218', borderWidth: 1, borderColor: '#30414E' },
  loadingText: { ...typography.body, color: colors.textMuted },
  grid: { paddingHorizontal: spacing.md, flexDirection: 'row', flexWrap: 'wrap', gap: 12 },
  itemCard: { width: '48%', minHeight: 286, padding: 11, borderRadius: 23, backgroundColor: '#0B1218', borderWidth: 1, borderColor: '#292A27' },
  ...
  guardrails: { marginHorizontal: spacing.md, overflow: 'hidden', borderRadius: 23, backgroundColor: '#0B1218', borderWidth: 1, borderColor: '#30414E' },
  guardrail: { minHeight: 67, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', gap: 12, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#30414E' },
  ...
  primaryDisabled: { backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E', boxShadow: 'none' },
  primaryText: { ...typography.action, color: '#080A0C', fontSize: 14 },
  primaryTextDisabled: { color: '#737D85' },
  restore: { minHeight: 48, marginHorizontal: spacing.md, alignItems: 'center', justifyContent: 'center', borderRadius: 16, backgroundColor: '#0B1218', borderWidth: 1, borderColor: '#30414E' },
