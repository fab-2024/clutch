...
const styles = StyleSheet.create({
  ...
  evolutionStep: { flexBasis: '30%', flexGrow: 1, minHeight: 124, paddingVertical: 7, alignItems: 'center', borderRadius: 15, backgroundColor: '#05090C', borderWidth: 1, borderColor: '#202B32' },
  ...
  card: { position: 'relative', width: '48%', minHeight: 378, padding: 10, borderRadius: 21, backgroundColor: '#090E13', borderWidth: 1, borderColor: '#26313A' },
  ...
  shopState: { minHeight: 44, marginTop: 'auto', alignItems: 'center', justifyContent: 'center', borderRadius: 11, backgroundColor: '#10161B', borderWidth: 1, borderColor: '#28333B' },
