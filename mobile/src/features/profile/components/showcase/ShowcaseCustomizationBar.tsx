...
const styles = StyleSheet.create({
  ...
  pedestalTop: { zIndex: 3, width: 13, height: 4, marginBottom: -1, borderRadius: 999, backgroundColor: '#111A22', borderWidth: 1 },
  pedestalBody: { width: 15, height: 6, borderRadius: 2 },
  pedestalFoot: { width: 18, height: 4, marginTop: -1, borderTopWidth: 1, borderRadius: 999, backgroundColor: '#0B1218' },
  ...
  themeMiniature: { position: 'relative', overflow: 'hidden', width: 20, height: 15, padding: 3, justifyContent: 'space-around', borderRadius: 2, borderWidth: 1, borderColor: '#30414E' },
  ...
  lightOrbOuter: { position: 'relative', width: 16, height: 16, alignItems: 'center', justifyContent: 'center', borderRadius: 8, borderWidth: 1, borderColor: '#30414E' },
