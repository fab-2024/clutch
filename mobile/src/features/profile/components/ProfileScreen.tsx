...
const styles = StyleSheet.create({
  blockedState: { flex: 1, minHeight: 560, margin: spacing.lg, padding: spacing.lg, alignItems: 'center', justifyContent: 'center', gap: 10, borderRadius: radius.lg, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E' },
  ...
  header: { minHeight: 72, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 14, borderBottomWidth: 1, borderBottomColor: '#30414E' }, back: { minHeight: 40, paddingHorizontal: 12, alignItems: 'center', justifyContent: 'center', borderRadius: 13, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E' }, backText: { ...typography.action, color: colors.text, letterSpacing: 0.6 }, headerActions: { flexDirection: 'row', alignItems: 'center', gap: 6 }, visibility: { minHeight: 40, flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 12, borderRadius: 14, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E' }, visibilityDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: colors.volt }, visibilityDotPrivate: { backgroundColor: '#FFB84D' }, visibilityText: { ...typography.label, color: colors.text, letterSpacing: 0.5 }, headerSettings: { width: 38, height: 38, alignItems: 'center', justifyContent: 'center', borderRadius: 12, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E' }, headerSettingsGlyph: { color: colors.text, fontSize: 17, lineHeight: 20, fontWeight: '900' },
  ...
  xpBlock: { marginHorizontal: spacing.md, padding: 14, borderRadius: 18, backgroundColor: '#0B1218', borderWidth: 1, borderColor: '#30414E', gap: 8 }, xpTop: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 9 }, xpLabel: { ...typography.label, flex: 1, color: colors.textMuted, letterSpacing: 0.5 }, xpValue: { ...typography.bodyStrong, color: colors.text }, track: { height: 7, borderRadius: 999, overflow: 'hidden', backgroundColor: '#182028' }, trackFill: { height: '100%', borderRadius: 999, backgroundColor: colors.volt }, xpHint: { ...typography.caption, color: colors.textMuted },
  gradeCard: { marginHorizontal: spacing.md, padding: 15, borderRadius: 25, gap: 13, backgroundColor: '#111A22', borderWidth: 1 },
  ...
  gradeTrack: { height: 7, overflow: 'hidden', borderRadius: 4, backgroundColor: '#152633' },
  ...
  gradeRecordDivider: { width: 1, marginVertical: 5, backgroundColor: '#152633' },
  statsGrid: { marginHorizontal: spacing.md, flexDirection: 'row', flexWrap: 'wrap', gap: 9 }, stat: { flexBasis: '48.5%', minHeight: 122, padding: 14, borderRadius: 22, backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border }, statFeatured: { backgroundColor: '#11170E', borderColor: '#414D1E' }, statLabel: { ...typography.eyebrow, color: colors.textMuted, letterSpacing: .7 }, statValue: { ...typography.metric, marginTop: 10, color: colors.text }, statValueCompact: { fontSize: 20, lineHeight: 22, letterSpacing: -.3 }, statValueFeatured: { color: colors.frag }, statDetailRow: { marginTop: 'auto', flexDirection: 'row', alignItems: 'center', gap: 4 }, statDetail: { ...typography.caption, color: colors.textMuted },
  ...
  factionCard: { position: 'relative', overflow: 'hidden', minHeight: 126, marginHorizontal: spacing.md, padding: 15, borderRadius: 25, flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border }, teamMark: { width: 58, height: 58, borderRadius: 18, alignItems: 'center', justifyContent: 'center', backgroundColor: '#0B1218', borderWidth: 1 }, teamMarkText: { ...typography.bodyStrong }, factionCopy: { flex: 1 }, factionEyebrow: { ...typography.eyebrow, color: colors.textMuted, letterSpacing: 0.6 }, factionName: { ...typography.cardTitle, marginTop: 4, color: colors.text }, factionMeta: { ...typography.caption, marginTop: 4, color: colors.textMuted }, arrow: { color: colors.volt, fontSize: 18, fontWeight: '900' },
  arsenalRail: { gap: 10, paddingHorizontal: spacing.md }, arsenalCard: { width: 148, minHeight: 184, padding: 14, borderRadius: 24, backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border }, arsenalArtwork: { width: 64, height: 64, alignItems: 'center', justifyContent: 'center', overflow: 'hidden', borderRadius: 20, backgroundColor: '#0B1218' }, arsenalName: { ...typography.bodyStrong, marginTop: 11, color: colors.text }, arsenalRarity: { ...typography.eyebrow, marginTop: 'auto', letterSpacing: 0.5 }, arsenalEmpty: { width: 270, minHeight: 166, justifyContent: 'center', padding: 18, borderRadius: 24, backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border }, arsenalEmptyTitle: { ...typography.cardTitle, color: colors.text }, arsenalEmptyText: { ...typography.body, marginTop: 7, color: colors.textMuted },
  verdicts: { marginHorizontal: spacing.md, overflow: 'hidden', borderRadius: 23, backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border }, verdictRow: { minHeight: 80, flexDirection: 'row', alignItems: 'center', gap: 11, paddingHorizontal: 13, borderBottomWidth: 1, borderBottomColor: '#30414E' }, verdictMark: { width: 36, height: 36, borderRadius: 12, alignItems: 'center', justifyContent: 'center', borderWidth: 1 }, verdictMarkWin: { backgroundColor: '#0E1C14', borderColor: '#23583A' }, verdictMarkLoss: { backgroundColor: '#1A1012', borderColor: '#5A2730' }, verdictLetter: { ...typography.bodyStrong }, verdictWin: { color: colors.success }, verdictLoss: { color: colors.danger }, verdictCopy: { flex: 1, minWidth: 0 }, verdictTitle: { ...typography.bodyStrong, color: colors.text }, verdictMeta: { ...typography.caption, marginTop: 3, color: colors.textMuted }, deltaRow: { flexDirection: 'row', alignItems: 'center', gap: 4 }, delta: { ...typography.bodyStrong },
