...
const styles = StyleSheet.create({
  root: {
    ...
    borderBottomWidth: 1,
    borderBottomColor: '#202A32',
  },
  back: { width: 31, alignItems: 'center', justifyContent: 'center', borderRightWidth: 1, borderRightColor: '#1B242B' },
  backGlyph: { color: '#C5CDD3', fontSize: 22, lineHeight: 24, fontWeight: '500' },
  tabs: { flex: 1, minWidth: 0, flexDirection: 'row' },
  tab: { position: 'relative', flex: 1, minWidth: 0, paddingHorizontal: 3, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5, borderRightWidth: 1, borderRightColor: '#151D23' },
  tabSelected: { backgroundColor: 'rgba(232,255,61,.028)' },
  tabGlyph: { color: '#74808A', fontSize: 10, lineHeight: 12 },
  tabText: { ...typography.label, color: '#929EA8', fontSize: 7.5, letterSpacing: 0.38 },
  ...
  count: { width: 43, alignItems: 'center', justifyContent: 'center', borderLeftWidth: 1, borderLeftColor: '#1B242B' },
  countValue: { ...typography.bodyStrong, color: colors.text, fontSize: 11 },
  countLabel: { ...typography.label, marginTop: -1, color: '#73808B', fontSize: 6 },
  refresh: { width: 31, alignItems: 'center', justifyContent: 'center' },
