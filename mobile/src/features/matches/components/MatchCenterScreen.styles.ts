...
export const styles = StyleSheet.create({
  ...
  selectionOutcomeMeta: { ...typography.caption, color: colors.textMuted, letterSpacing: .25 },
  lockCountdown: { minHeight: 28, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7 },
  lockCountdownLabel: { ...typography.label, color: colors.textMuted, letterSpacing: .7 },
  lockCountdownValue: { ...typography.label, color: colors.volt, letterSpacing: .45 },
  ...
  confirmButton: { minHeight: 56, paddingHorizontal: spacing.md, borderRadius: 11, backgroundColor: colors.volt, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', boxShadow: `0 9px 24px ${colors.volt}20` },
  confirmPressed: { opacity: .85 },
  confirmText: { ...typography.metricSmall, color: '#080B0F', fontSize: 18, lineHeight: 20, letterSpacing: .15 },
  confirmArrow: { color: '#080B0F', fontSize: 22, fontWeight: '900' },
  deferButton: { minHeight: 28, alignItems: 'center', justifyContent: 'center' },
  deferText: { ...typography.caption, color: colors.textMuted },
