...
export const styles = StyleSheet.create({
  ...
  heroLandscape: { padding: spacing.md, borderRadius: 24, gap: spacing.sm },
  heroPicker: { padding: spacing.md, borderRadius: 24, gap: spacing.xs },
  heroAccent: { position: 'absolute', top: 0, left: 0, right: 0, height: 2, backgroundColor: colors.volt },
  heroWatermarks: { position: 'absolute', inset: 0, overflow: 'hidden' },
  heroWatermark: { position: 'absolute', top: 48 },
  heroWatermarkPicker: { top: 34 },
  heroWatermarkLeft: { left: -50, transform: [{ rotateZ: '7deg' }] },
  heroWatermarkRight: { right: -50, transform: [{ rotateZ: '-7deg' }] },
  metaRow: { zIndex: 2, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8 },
  ...
  duelPicker: { paddingVertical: 2 },
  heroTeam: { width: '36%', alignItems: 'center', gap: 7 },
  heroTeamLandscape: { width: '35%', gap: 4 },
  heroTeamPicker: { width: '37%', gap: 3 },
  heroTeamMark: { position: 'relative', overflow: 'hidden', width: 78, height: 78, borderRadius: 24, backgroundColor: colors.surfaceElevated, borderWidth: 1, borderColor: colors.border, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 5 },
  heroTeamMarkLandscape: { width: 62, height: 62, borderRadius: 20 },
  heroTeamMarkPicker: { width: 60, height: 60, borderRadius: 19 },
  heroTeamGlow: { position: 'absolute', top: -22, width: 70, height: 48, borderRadius: 35, opacity: .13 },
  heroTeamWinner: { backgroundColor: '#1B2215', borderColor: '#4A5B23' },
  heroTeamTag: { ...typography.metricSmall, color: colors.text },
  heroTeamTagPicker: { fontSize: 20, lineHeight: 22 },
  heroTeamName: { ...typography.bodyStrong, color: colors.text, textAlign: 'center' },
  heroTeamNamePicker: { ...typography.caption, width: '100%' },
  ...
  probabilityWrap: { zIndex: 2, gap: 7 },
  ...
  contractDistributionValue: { ...typography.bodyStrong },
  contractDistributionTrack: { height: 6, borderRadius: 3, overflow: 'hidden' },
  contractDistributionFill: { height: '100%' },
  ...
  loadingArenaBackdrop: { position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, borderRadius: 29 },
  ...
  loadingTeam: { width: 88, alignItems: 'center', gap: 6 },
  loadingTeamMark: { width: 72, height: 72, overflow: 'hidden', borderRadius: 23, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 4, backgroundColor: colors.surfaceElevated, borderWidth: 1, borderColor: colors.border },
