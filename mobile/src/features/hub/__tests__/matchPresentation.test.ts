...
describe('hub match confrontation presentation', () => {
  ...
  it('distinguishes upcoming, live, finished and cancelled states', () => {
    ...
    expect(getHubMatchPhase({ ...BASE_MATCH, statut: 'en_cours', debut: '2026-08-23T17:30:00.000Z' }, NOW)).toBe('live');
    expect(getHubMatchPhase({ ...BASE_MATCH, statut: 'a_venir', debut: '2026-08-23T17:59:00.000Z' }, NOW)).toBe('pending');
