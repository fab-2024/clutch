...
const styles = StyleSheet.create({
  card: { padding: 15, gap: 11, borderRadius: radius.lg, backgroundColor: '#0B1015', borderWidth: 1, borderColor: '#2B343D' }, eyebrow: { ...typography.eyebrow, color: colors.textMuted }, title: { ...typography.cardTitle, marginTop: 3, color: colors.text }, actions: { flexDirection: 'row', gap: 9 }, secondary: { flex: 1, minHeight: 44, alignItems: 'center', justifyContent: 'center', borderRadius: 14, borderWidth: 1, borderColor: '#46515B' }, secondaryText: { ...typography.action, color: colors.text }, danger: { flex: 1, minHeight: 44, alignItems: 'center', justifyContent: 'center', borderRadius: 14, backgroundColor: '#35151C', borderWidth: 1, borderColor: '#6D2C38' }, dangerText: { ...typography.action, color: '#FF9AA6' }, panel: { padding: 12, gap: 9, borderRadius: 16, backgroundColor: '#080C10', borderWidth: 1, borderColor: '#27313A' }, panelTitle: { ...typography.bodyStrong, color: colors.text }, panelText: { ...typography.body, color: colors.textMuted }, reasons: { flexDirection: 'row', flexWrap: 'wrap', gap: 7 }, reason: { minHeight: 36, paddingHorizontal: 10, justifyContent: 'center', borderRadius: 12, backgroundColor: '#141B21' }, reasonText: { ...typography.label, color: colors.textSubtle }, confirm: { minHeight: 43, alignItems: 'center', justifyContent: 'center', borderRadius: 13, backgroundColor: '#E85066' }, confirmText: { ...typography.action, color: '#16070A' }, message: { ...typography.label, color: colors.volt }, pressed: { opacity: .72 },
});
