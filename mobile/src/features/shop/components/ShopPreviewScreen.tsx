...
const DEFINITIONS: [CosmeticSlot, string, string, string, number, string][] = [
  ...
  ['apparence_core', 'Core Plasma', 'core-plasma', '#FF5DDF', 100, 'rare'],
  ['apparence_core', 'Core Holographique', 'core-holo', '#54D9FF', 200, 'epique'],
  ['apparence_core', 'Core Éclipse', 'core-eclipse', '#F5F6F2', 300, 'legendaire'],
