...
const styles = StyleSheet.create({
  ...
  list: { gap: 9 },
  card: { minHeight: 82, flexDirection: 'row', alignItems: 'center', gap: 12, padding: 13, borderRadius: radius.lg, backgroundColor: '#0C1117', borderWidth: 1, borderColor: '#1D2730' },
  ...
  input: { ...typography.bodyStrong, minHeight: 48, paddingHorizontal: 13, borderRadius: radius.md, backgroundColor: '#080C10', borderWidth: 1, borderColor: '#202A34', color: colors.text },
