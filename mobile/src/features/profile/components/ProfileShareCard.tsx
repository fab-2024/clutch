...
const styles = StyleSheet.create({
  ...
  metrics: { zIndex: 1, minHeight: 63, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 9, borderRadius: radius.lg, backgroundColor: 'rgba(3,7,10,.62)', borderWidth: 1, borderColor: '#30414E' },
  ...
  divider: { width: 1, height: 28, backgroundColor: '#152633' },
