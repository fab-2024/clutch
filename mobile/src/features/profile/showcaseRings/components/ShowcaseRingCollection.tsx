...
const styles = StyleSheet.create({
  ...
  state: { minHeight: 28, marginTop: 5, paddingHorizontal: 7, flexDirection: 'row', alignItems: 'center', gap: 5, borderRadius: 14, backgroundColor: '#11171D', borderWidth: 1, borderColor: '#303A43' },
  ...
  nextRow: { minHeight: 56, paddingTop: 11, flexDirection: 'row', alignItems: 'center', gap: 10, borderTopWidth: 1, borderTopColor: '#202A32' },
