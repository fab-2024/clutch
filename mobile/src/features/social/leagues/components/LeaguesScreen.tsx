...
const styles = StyleSheet.create({
  ...
  sectionEyebrow: { ...typography.eyebrow, color: colors.textMuted, letterSpacing: .9 },
  sectionMeta: { ...typography.label, color: colors.textMuted },
  list: { gap: 9 },
  card: { minHeight: 82, flexDirection: 'row', alignItems: 'center', gap: 12, padding: 13, borderRadius: radius.lg, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E' },
  ...
  cardMarkText: { ...typography.metricSmall, color: colors.volt },
  cardCopy: { flex: 1, minWidth: 0 },
  cardName: { ...typography.cardTitle, color: colors.text },
  cardMeta: { ...typography.caption, marginTop: 4, color: colors.textMuted },
  cardArrow: { color: colors.volt, fontSize: 18 },
  empty: { padding: 25, borderRadius: radius.lg, backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border },
  emptyTitle: { ...typography.sectionTitle, color: colors.text },
  emptyText: { ...typography.body, marginTop: 9, color: colors.textMuted },
  actionsGrid: { gap: 10 },
  actionCard: { padding: 15, borderRadius: radius.lg, backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border, gap: 10 },
  actionEyebrow: { ...typography.eyebrow, color: colors.volt, letterSpacing: .8 },
  actionTitle: { ...typography.cardTitle, color: colors.text },
  input: { ...typography.bodyStrong, minHeight: 48, paddingHorizontal: 13, borderRadius: radius.md, backgroundColor: '#0B1218', borderWidth: 1, borderColor: '#30414E', color: colors.text },
  codeInput: { letterSpacing: 2, fontFamily: typography.action.fontFamily },
  primaryButton: { minHeight: 46, alignItems: 'center', justifyContent: 'center', borderRadius: radius.md, backgroundColor: colors.volt },
  primaryButtonText: { ...typography.action, color: '#080A0C', letterSpacing: .5 },
  ...
  skeletonRow: { minHeight: 82, padding: 13, flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: radius.lg, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E' },
