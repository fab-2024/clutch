...
const styles = StyleSheet.create({
  ...
  backText: { color: colors.text, fontSize: 8, fontWeight: '900', letterSpacing: 0.9 },
  ...
  intro: { gap: 8 }, eyebrow: { color: colors.volt, fontSize: 9, fontWeight: '900', letterSpacing: 1.5 }, title: { maxWidth: 360, color: colors.text, fontSize: 37, lineHeight: 37, fontWeight: '900', letterSpacing: -1.7 }, subtitle: { maxWidth: 360, color: colors.textMuted, fontSize: 13, lineHeight: 19 },
  error: { padding: 12, borderRadius: radius.md, backgroundColor: '#1A1012', borderWidth: 1, borderColor: '#4A2027' }, errorText: { color: '#FF9AA2', fontSize: 10, lineHeight: 15 },
  success: { padding: 12, borderRadius: radius.md, backgroundColor: '#0E1C14', borderWidth: 1, borderColor: '#23583A' }, successText: { color: colors.success, fontSize: 8, fontWeight: '900', letterSpacing: 0.6 },
  section: { gap: 12 }, sectionHeading: { flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', gap: 12 }, sectionEyebrow: { color: colors.volt, fontSize: 8, fontWeight: '900', letterSpacing: 1.2 }, sectionTitle: { marginTop: 4, color: colors.text, fontSize: 24, lineHeight: 25, fontWeight: '900', letterSpacing: -0.9 }, sectionMeta: { color: colors.textMuted, fontSize: 9, fontWeight: '900' }, sectionCopy: { color: colors.textMuted, fontSize: 10, lineHeight: 15 },
  gamesGrid: { flexDirection: 'row', gap: 8 },
  gameCard: { flex: 1, minHeight: 150, padding: 11, borderRadius: 21, backgroundColor: '#0B1015', borderWidth: 1, borderColor: colors.border }, gameCardActive: { backgroundColor: '#11170E', borderColor: '#48541E' },
  gameMark: { width: 38, height: 38, borderRadius: 12, alignItems: 'center', justifyContent: 'center', borderWidth: 1, backgroundColor: '#0A0F14' }, gameCode: { fontSize: 15, fontWeight: '900' }, gameShort: { marginTop: 15, color: colors.text, fontSize: 12, fontWeight: '900' }, gameName: { marginTop: 3, color: colors.textMuted, fontSize: 7 }, gameState: { marginTop: 'auto', color: '#596570', fontSize: 6, fontWeight: '900', letterSpacing: 0.7 }, gameStateActive: { color: colors.volt },
  validation: { color: '#FF9AA2', fontSize: 9, lineHeight: 14 },
  teamRail: { gap: 9, paddingRight: spacing.md }, teamSkeleton: { height: 165, borderRadius: 24, backgroundColor: '#10161D' },
  teamCard: { width: 146, minHeight: 165, padding: 13, borderRadius: 23, backgroundColor: '#0B1015', borderWidth: 1, borderColor: colors.border }, teamCardActive: { backgroundColor: '#11170E', borderColor: '#48541E' },
  teamMark: { width: 50, height: 50, borderRadius: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: '#111820', borderWidth: 1, borderColor: '#303A43' }, teamMarkActive: { backgroundColor: colors.volt, borderColor: colors.volt }, teamTag: { color: colors.text, fontSize: 10, fontWeight: '900' }, teamTagActive: { color: '#080A0C' }, teamName: { marginTop: 16, color: colors.text, fontSize: 13, lineHeight: 15, fontWeight: '900' }, teamGames: { marginTop: 'auto', color: colors.textMuted, fontSize: 7, fontWeight: '900' }, teamGamesActive: { color: colors.volt },
  visibilityCard: { minHeight: 100, padding: 15, flexDirection: 'row', alignItems: 'center', gap: 15, borderRadius: 24, backgroundColor: '#0B1015', borderWidth: 1, borderColor: colors.border }, visibilityCopy: { flex: 1, minWidth: 0 }, visibilityTitle: { color: colors.text, fontSize: 15, fontWeight: '900' }, visibilityMeta: { marginTop: 5, color: colors.textMuted, fontSize: 9, lineHeight: 14 },
  ...
  save: { minHeight: 58, paddingHorizontal: 18, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderRadius: 18, backgroundColor: colors.volt }, saveText: { color: '#080A0C', fontSize: 10, fontWeight: '900', letterSpacing: 0.7 }, saveArrow: { color: '#080A0C', fontSize: 18, fontWeight: '900' },
