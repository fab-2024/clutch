...
export const SHOWCASE_RANK_DISPLAY_CATALOG: readonly ShowcaseRankDisplayDefinition[] = [
  {
    ...
    accent: '#31D7E2',
    image: require('../../../assets/shop/atelier/ranks/overlays/rank-mechanical-carbon-opaque.png'),
    overlayImage: require('../../../assets/shop/atelier/ranks/overlays/rank-mechanical-carbon-opaque.png'),
    price: 0,
    rarity: 'commun',
  },
  {
  ...
  },
  {
    ...
    accent: '#D7B77A',
    image: require('../../../assets/shop/atelier/ranks/overlays/rank-royal-crown-opaque.png'),
    overlayImage: require('../../../assets/shop/atelier/ranks/overlays/rank-royal-crown-opaque.png'),
    price: 220,
    rarity: 'rare',
  },
  {
  ...
  },
  {
    ...
    accent: '#F5792A',
    image: require('../../../assets/shop/atelier/ranks/overlays/rank-volcanic-forge-opaque.png'),
    overlayImage: require('../../../assets/shop/atelier/ranks/overlays/rank-volcanic-forge-opaque.png'),
    price: 300,
    rarity: 'epique',
  },
  {
