...
import { loadProfileData, type ProfileBadge, type ProfileData, type RecentPrediction } from '@/src/services/profile';
    ...
    <Screen>
      ...
      >
        ...
        <View style={styles.accountCard}>
          ...
          <Pressable onPress={() => void supabase.auth.signOut()} style={({ pressed }) => [styles.logout, pressed && styles.pressed]}><Text style={styles.logoutText}>SE DÉCONNECTER</Text></Pressable>
        </View>
      </ScrollView>
    </Screen>
  );
...
const styles = StyleSheet.create({
  ...
  xpBlock: { zIndex: 2, marginTop: 'auto', padding: 14, borderRadius: 18, backgroundColor: '#080D11', borderWidth: 1, borderColor: '#202A32', gap: 8 }, xpTop: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, xpLabel: { color: colors.textMuted, fontSize: 7, fontWeight: '900', letterSpacing: 0.9 }, xpValue: { color: colors.text, fontSize: 12, fontWeight: '900' }, track: { height: 7, borderRadius: 999, overflow: 'hidden', backgroundColor: '#182028' }, trackFill: { height: '100%', borderRadius: 999, backgroundColor: colors.volt }, xpHint: { color: colors.textMuted, fontSize: 8 },
  statsGrid: { marginHorizontal: spacing.md, flexDirection: 'row', flexWrap: 'wrap', gap: 9 }, stat: { flexBasis: '48.5%', minHeight: 102, padding: 14, borderRadius: 22, backgroundColor: '#0B1015', borderWidth: 1, borderColor: colors.border }, statFeatured: { backgroundColor: '#11170E', borderColor: '#414D1E' }, statLabel: { color: colors.textMuted, fontSize: 7, fontWeight: '900', letterSpacing: 1 }, statValue: { marginTop: 10, color: colors.text, fontSize: 25, fontWeight: '900', letterSpacing: -1 }, statValueFeatured: { color: colors.volt }, statDetail: { marginTop: 'auto', color: colors.textMuted, fontSize: 7, fontWeight: '900' },
