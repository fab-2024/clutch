...
const DEFINITIONS: [CosmeticSlot, string, string, string, number, string][] = [
  ...
  ['cadre_profil', 'Signal Volt', 'frame-volt', '#E8FF3D', 100, 'rare'],
  ['cadre_profil', 'Prisme Arena', 'frame-prism', '#63B8FF', 200, 'epique'],
  ['cadre_profil', 'Obsidienne', 'frame-obsidian', '#B68CFF', 300, 'legendaire'],
  ['titre_profil', 'Débutant du Call', 'title-rookie', '#AAB4BE', 0, 'commun'],
  ['titre_profil', 'Lecteur du Jeu', 'title-reader', '#63B8FF', 100, 'rare'],
  ['titre_profil', 'Instinct GRIFF', 'title-instinct', '#E8FF3D', 200, 'epique'],
  ['titre_profil', 'Architecte du Chaos', 'title-architect', '#FFB84D', 300, 'legendaire'],
  ['apparence_core', 'Noyau Origine', 'core-origin', '#E8FF3D', 0, 'commun'],
  ['apparence_core', 'Noyau Plasma', 'core-plasma', '#FF5DDF', 100, 'rare'],
  ['apparence_core', 'Noyau Holographique', 'core-holo', '#54D9FF', 200, 'epique'],
  ['apparence_core', 'Noyau Éclipse', 'core-eclipse', '#F5F6F2', 300, 'legendaire'],
  ['effet_faction', 'Aura Discrète', 'faction-aura', '#C6A34A', 0, 'commun'],
  ['effet_faction', 'Veines Volt', 'faction-veins', '#E8FF3D', 100, 'rare'],
  ['effet_faction', 'Éclat de Guerre', 'faction-war', '#FFB84D', 200, 'epique'],
  ['effet_faction', 'Mutation Instable', 'faction-mutation', '#D886FF', 300, 'legendaire'],
  ['carte_profil', 'Carte Noire', 'card-black', '#AAB4BE', 0, 'commun'],
  ['carte_profil', 'Signal Acide', 'card-signal', '#E8FF3D', 100, 'rare'],
  ['carte_profil', 'Scoreboard', 'card-scoreboard', '#63B8FF', 200, 'epique'],
  ['carte_profil', 'Légende Nocturne', 'card-nocturne', '#A982FF', 300, 'legendaire'],
];
