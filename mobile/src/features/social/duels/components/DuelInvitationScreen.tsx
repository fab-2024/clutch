...
const styles = StyleSheet.create({
  ...
  skeleton: { height: 340, borderRadius: 30, backgroundColor: '#111A22' },
  ...
  hero: { position: 'relative', overflow: 'hidden', minHeight: 372, padding: 19, borderRadius: 30, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E' }, blueGlow: { position: 'absolute', left: -80, bottom: -65, width: 280, height: 280, borderRadius: 140, backgroundColor: '#123A67', opacity: 0.55 }, redGlow: { position: 'absolute', right: -80, bottom: -65, width: 280, height: 280, borderRadius: 140, backgroundColor: '#5B173C', opacity: 0.5 },
  ...
  status: { minHeight: 32, flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 9, borderRadius: 999, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E' }, statusActive: { backgroundColor: '#171E0E', borderColor: '#3D491D' }, statusDot: { width: 5, height: 5, borderRadius: 3, backgroundColor: colors.textMuted }, statusDotActive: { backgroundColor: colors.volt }, statusText: { ...typography.metadata, color: colors.textMuted, letterSpacing: .2 }, statusTextActive: { color: colors.volt },
  actionPanel: { padding: 18, borderRadius: 26, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E', gap: 11 }, actionEyebrow: { ...typography.eyebrow, color: colors.volt, letterSpacing: .9 }, actionTitle: { ...typography.sectionTitle, color: colors.text }, actionCopy: { ...typography.body, color: colors.textMuted }, inviteUrl: { ...typography.metadata, padding: 11, borderRadius: 12, backgroundColor: '#0B1218', color: colors.textMuted }, primary: { minHeight: 50, alignItems: 'center', justifyContent: 'center', borderRadius: 15, backgroundColor: colors.volt }, primaryText: { ...typography.control, color: '#080A0C', letterSpacing: .4 }, danger: { minHeight: 44, alignItems: 'center', justifyContent: 'center', borderRadius: 13, backgroundColor: '#181014', borderWidth: 1, borderColor: '#47252D' }, dangerText: { ...typography.control, color: colors.liveText, letterSpacing: .3 },
  closedPanel: { padding: 19, borderRadius: 25, backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border, gap: 7 }, closedTitle: { ...typography.cardTitle, color: colors.text }, closedCopy: { ...typography.body, color: colors.textMuted },
  ...
  rules: { padding: 18, borderRadius: 24, backgroundColor: '#0B1218', borderWidth: 1, borderColor: colors.border }, rulesEyebrow: { ...typography.eyebrow, color: colors.textMuted, letterSpacing: .8 }, rulesTitle: { ...typography.cardTitle, marginTop: 7, color: colors.text }, rulesCopy: { ...typography.body, marginTop: 7, color: colors.textMuted },
