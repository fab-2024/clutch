...
const styles = StyleSheet.create({
  ...
  back: { minHeight: 42, paddingHorizontal: 11, alignItems: 'center', justifyContent: 'center', borderRadius: 13, backgroundColor: '#0D1016', borderWidth: 1, borderColor: '#302A42' },
  ...
  secondaryButton: { minHeight: 47, paddingHorizontal: 17, alignItems: 'center', justifyContent: 'center', borderRadius: 14, backgroundColor: '#171C22' },
  ...
  taskCard: { minHeight: 150, padding: 14, flexDirection: 'row', gap: 12, borderRadius: 23, backgroundColor: '#0B0E14', borderWidth: 1, borderColor: '#292634' },
  ...
  matchCard: { width: 238, minHeight: 218, padding: 14, borderRadius: 23, backgroundColor: '#0B0E14', borderWidth: 1, borderColor: '#2A2833' },
  ...
  versus: { minHeight: 58, marginTop: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 13, borderRadius: 16, backgroundColor: '#12151C' },
  ...
  rewardCard: { width: 184, minHeight: 300, padding: 12, borderRadius: 23, backgroundColor: '#0B0E14', borderWidth: 1 },
  rewardVisual: { position: 'relative', height: 126, overflow: 'hidden', alignItems: 'center', justifyContent: 'center', borderRadius: 18, backgroundColor: '#090B11', borderWidth: 1, borderColor: '#282431' },
  ...
  claimPanel: { minHeight: 204, marginHorizontal: spacing.md, padding: 17, borderRadius: 25, backgroundColor: '#0B0E14', borderWidth: 1, borderColor: '#2D2936', gap: 14 },
  ...
  claimButtonLocked: { backgroundColor: '#161921', borderWidth: 1, borderColor: '#30323A' },
  claimButtonText: { ...typography.action, color: '#090A0D' },
  claimButtonTextLocked: { color: '#6C6E76' },
  fairnessCard: { minHeight: 158, marginHorizontal: spacing.md, padding: 16, flexDirection: 'row', gap: 13, borderRadius: 24, backgroundColor: '#0A0D12', borderWidth: 1, borderColor: '#272A31' },
