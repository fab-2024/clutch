...
const styles = StyleSheet.create({
  ...
  header: { minHeight: 72, justifyContent: 'center', borderBottomWidth: 1, borderBottomColor: '#30414E' }, back: { minHeight: 38, alignSelf: 'flex-start', paddingHorizontal: 12, alignItems: 'center', justifyContent: 'center', borderRadius: 13, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E' }, backText: { ...typography.action, color: colors.text },
  ...
  links: { overflow: 'hidden', borderRadius: radius.lg, borderWidth: 1, borderColor: colors.border }, linkRow: { minHeight: 58, paddingHorizontal: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#111A22', borderBottomWidth: 1, borderBottomColor: '#30414E' }, linkLabel: { ...typography.bodyStrong, color: colors.text }, linkArrow: { color: colors.volt, fontSize: 19 },
