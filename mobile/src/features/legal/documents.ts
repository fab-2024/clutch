...
export const privacyDocument: LegalDocument = {
  ...
  introduction: `${legalEntity} conçoit GRIFF avec une collecte limitée aux données nécessaires au fonctionnement du produit. Cette politique explique les données traitées, leurs usages et tes droits.`,
  sections: [
    {
      ...
      paragraphs: [
        ...
        'Achat : GRIFF conserve uniquement un statut et des références techniques validées côté serveur. Les données de paiement restent gérées par Apple, Google et RevenueCat.',
        'Mesure d’usage facultative : si tu l’acceptes, GRIFF conserve des événements produit strictement prédéfinis, sans identifiant publicitaire, sans identifiant d’appareil et sans métadonnée libre.',
      ],
    },
    {
      title: 'Finalités',
    ...
    },
    {
      title: 'Âge minimum',
      paragraphs: [
        'GRIFF est réservé aux personnes âgées de 15 ans ou plus. L’application conserve uniquement la confirmation de cette condition, jamais une date de naissance.',
      ],
    },
    {
      title: 'Tes droits',
...
export const termsDocument: LegalDocument = {
  ...
  updatedAt: '22 août 2026',
  introduction: `En créant un compte GRIFF, tu acceptes les présentes conditions proposées par ${legalEntity}. GRIFF est un jeu social de prédiction e-sport, sans mise d’argent réel.`,
  sections: [
    {
      title: 'Compte',
      paragraphs: [
        'Tu dois avoir au moins 15 ans pour utiliser GRIFF. Si cette condition n’est pas remplie, tu ne dois pas créer ou conserver de compte.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'GRIFF peut masquer un contenu, limiter une fonction sociale, suspendre ou fermer un compte en cas de harcèlement, haine, menace, usurpation, spam, triche, contenu illégal ou atteinte aux droits d’autrui. Les signalements sont examinés selon leur gravité et leur contexte.',
      ],
    },
    {
      title: 'Compétition',
