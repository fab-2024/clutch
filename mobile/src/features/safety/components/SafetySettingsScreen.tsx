...
const styles = StyleSheet.create({
  ...
  header: { minHeight: 72, justifyContent: 'center', borderBottomWidth: 1, borderBottomColor: '#30414E' }, back: { minHeight: 38, alignSelf: 'flex-start', paddingHorizontal: 12, justifyContent: 'center', borderRadius: 13, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E' }, backText: { ...typography.action, color: colors.text },
  ...
  preference: { minHeight: 122, padding: 15, flexDirection: 'row', alignItems: 'center', gap: 13, borderRadius: radius.lg, backgroundColor: '#111A22', borderWidth: 1, borderColor: colors.border }, preferenceCopy: { flex: 1, minWidth: 0 }, preferenceTitle: { ...typography.bodyStrong, color: colors.text }, preferenceText: { ...typography.caption, marginTop: 5, color: colors.textMuted },
  ...
  rules: { overflow: 'hidden', borderRadius: radius.lg, borderWidth: 1, borderColor: colors.border }, rule: { minHeight: 60, padding: 13, flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: '#111A22', borderBottomWidth: 1, borderBottomColor: '#30414E' }, ruleDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: colors.volt }, ruleText: { ...typography.body, flex: 1, color: colors.textMuted }, support: { ...typography.action, color: colors.volt },
  blockedList: { overflow: 'hidden', borderRadius: radius.lg, borderWidth: 1, borderColor: colors.border }, blockedRow: { minHeight: 70, padding: 13, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12, backgroundColor: '#111A22', borderBottomWidth: 1, borderBottomColor: '#30414E' }, blockedPseudo: { ...typography.bodyStrong, color: colors.text }, blockedDate: { ...typography.caption, marginTop: 3, color: colors.textMuted }, unblock: { minHeight: 38, paddingHorizontal: 10, justifyContent: 'center', borderRadius: 12, borderWidth: 1, borderColor: '#4A5625' }, unblockText: { ...typography.label, color: colors.volt }, empty: { ...typography.body, padding: 15, color: colors.textMuted, backgroundColor: '#111A22' }, pressed: { opacity: .72 },
});
