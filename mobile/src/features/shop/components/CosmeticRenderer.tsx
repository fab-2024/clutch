...
const styles = StyleSheet.create({
  ...
  preview: { height: 120, alignItems: 'center', justifyContent: 'center', overflow: 'hidden', borderRadius: 17, backgroundColor: '#0B1218', borderWidth: 1, borderColor: '#30414E' },
  framePreview: { width: 126, height: 78, padding: 10, flexDirection: 'row', alignItems: 'center', gap: 9, borderRadius: 18, backgroundColor: '#111A22', borderWidth: 2 },
  ...
  titlePreview: { width: 132, height: 74, padding: 11, justifyContent: 'center', borderRadius: 17, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E' },
  ...
  relicNeck: { width: 21, height: 25, marginBottom: -3, borderWidth: 1.5, borderBottomWidth: 0, borderTopLeftRadius: 7, borderTopRightRadius: 7, backgroundColor: '#111A22' },
  ...
  jerseyPreview: { position: 'relative', width: 142, height: 104, overflow: 'hidden', alignItems: 'center', justifyContent: 'center', borderRadius: 15, backgroundColor: '#0B1218', borderWidth: 1 },
