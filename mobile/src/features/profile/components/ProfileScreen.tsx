...
const styles = StyleSheet.create({
  ...
  statsGrid: { marginHorizontal: spacing.md, flexDirection: 'row', flexWrap: 'wrap', gap: 9 }, stat: { flexBasis: '48.5%', minHeight: 122, padding: 14, borderRadius: 22, backgroundColor: '#0B1015', borderWidth: 1, borderColor: colors.border }, statFeatured: { backgroundColor: '#11170E', borderColor: '#414D1E' }, statLabel: { ...typography.eyebrow, color: colors.textMuted, letterSpacing: .7 }, statValue: { ...typography.metric, marginTop: 10, color: colors.text }, statValueCompact: { fontSize: 20, lineHeight: 22, letterSpacing: -.3 }, statValueFeatured: { color: colors.volt }, statDetail: { ...typography.caption, marginTop: 'auto', color: colors.textMuted },
