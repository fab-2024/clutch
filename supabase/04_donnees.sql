...
insert into matchs (id, event_id, saison_id, jeu, equipe_a_id, equipe_b_id, format, debut, statut, score_a, score_b) values
  ...
  ('m-fini-4', 'rlcs-open', 'saison-ete-2026', 'rocket_league', 'rl-m8', 'rl-gen', 3, now() + interval '-70.00 hours', 'termine', 2, 0),
  ...
  ('m-fini-1', 'rlcs-major', 'saison-ete-2026', 'rocket_league', 'rl-kc', 'rl-g2', 3, now() + interval '-26.00 hours', 'termine', 2, 1),
