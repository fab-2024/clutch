...
const styles = StyleSheet.create({
  ...
  sheet: { width: '100%', maxWidth: layout.contentMaxWidth, maxHeight: '92%', alignSelf: 'center', borderTopLeftRadius: 31, borderTopRightRadius: 31, backgroundColor: '#0A0F14', borderWidth: 1, borderColor: '#313C45' },
  ...
  close: { width: 42, height: 42, alignItems: 'center', justifyContent: 'center', borderRadius: 14, backgroundColor: '#151B21', borderWidth: 1, borderColor: '#303A43' },
  closeText: { color: colors.text, fontSize: 25, lineHeight: 26 },
  artworkStage: { position: 'relative', minHeight: 180, alignItems: 'center', justifyContent: 'center', overflow: 'hidden', borderRadius: 24, backgroundColor: '#070B0F', borderWidth: 1, borderColor: '#202A32' },
  ...
  conditionPanel: { padding: 13, borderRadius: 17, backgroundColor: '#0D1318', borderWidth: 1, borderColor: '#29343D' },
  ...
  secretPanel: { padding: 15, borderRadius: 19, backgroundColor: '#0B1015', borderWidth: 1, borderColor: '#3A444C' },
  ...
  detailRow: { minHeight: 42, paddingHorizontal: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12, borderRadius: 14, backgroundColor: '#080C10', borderWidth: 1, borderColor: '#222C35' },
  ...
  slot: { flex: 1, minWidth: 0, height: 60, alignItems: 'center', justifyContent: 'center', borderRadius: 15, backgroundColor: '#10161B', borderWidth: 1, borderColor: '#303A43' },
