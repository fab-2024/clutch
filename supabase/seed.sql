...
insert into evenements (id, jeu, nom, tier) values
  ...
  ('rlcs-major', 'rocket_league', 'RLCS Major', 'S'),
  ('rlcs-open', 'rocket_league', 'RLCS Open', 'A'),
...
insert into equipes (id, jeu, nom, tag, elo) values
  ...
  ('rl-vit', 'rocket_league', 'Team Vitality', 'VIT', 1738),
  ('rl-kc', 'rocket_league', 'Karmine Corp', 'KC', 1710),
  ('rl-bds', 'rocket_league', 'Team BDS', 'BDS', 1691),
  ('rl-m8', 'rocket_league', 'Gentle Mates', 'M8', 1642),
  ('rl-nrg', 'rocket_league', 'NRG', 'NRG', 1598),
  ('rl-g2', 'rocket_league', 'G2 Stride', 'G2', 1635),
  ('rl-falcons', 'rocket_league', 'Team Falcons', 'FLC', 1654),
  ('rl-gen', 'rocket_league', 'Gen.G Mobil1 Racing', 'GEN', 1558),
  ('rl-ssg', 'rocket_league', 'Spacestation Gaming', 'SSG', 1536),
  ('rl-furia', 'rocket_league', 'FURIA', 'FUR', 1572),
...
insert into matchs (
  ...
  ('m-fini-4', 'rlcs-open', 'saison-ete-2026', 'rocket_league', 'rl-m8', 'rl-gen', 3, now() + interval '-70.00 hours', 'termine', 2, 0, 'seed_clutch', 'Données de démonstration', 'seed:m-fini-4', now() + interval '-68.00 hours', now() + interval '-68.00 hours', now() + interval '-68.00 hours', 1),
  ...
  ('m-fini-1', 'rlcs-major', 'saison-ete-2026', 'rocket_league', 'rl-kc', 'rl-g2', 3, now() + interval '-26.00 hours', 'termine', 2, 1, 'seed_clutch', 'Données de démonstration', 'seed:m-fini-1', now() + interval '-24.00 hours', now() + interval '-24.00 hours', now() + interval '-24.00 hours', 1),
...
insert into matchs (id, event_id, saison_id, jeu, equipe_a_id, equipe_b_id, format, debut, statut, score_a, score_b) values
  ('m-2', 'rlcs-major', 'saison-ete-2026', 'rocket_league', 'rl-vit', 'rl-kc', 3, now() + interval '2.00 hours', 'a_venir', null, null),
  ...
  ('m-5', 'rlcs-open', 'saison-ete-2026', 'rocket_league', 'rl-bds', 'rl-m8', 3, now() + interval '24.17 hours', 'a_venir', null, null),
  ...
  ('m-8', 'rlcs-major', 'saison-ete-2026', 'rocket_league', 'rl-nrg', 'rl-g2', 3, now() + interval '49.30 hours', 'a_venir', null, null),
  ...
  ('m-11', 'rlcs-open', 'saison-ete-2026', 'rocket_league', 'rl-falcons', 'rl-gen', 3, now() + interval '72.10 hours', 'a_venir', null, null),
  ...
  ('m-14', 'rlcs-major', 'saison-ete-2026', 'rocket_league', 'rl-vit', 'rl-bds', 5, now() + interval '99.88 hours', 'a_venir', null, null),
  ...
  ('m-17', 'rlcs-open', 'saison-ete-2026', 'rocket_league', 'rl-ssg', 'rl-furia', 3, now() + interval '144.08 hours', 'a_venir', null, null)
on conflict (id) do nothing;
