...
const styles = StyleSheet.create({
  ...
  upNextWhen: { ...typography.label, color: colors.volt, letterSpacing: .25, textShadowColor: 'rgba(0,0,0,.95)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 4 },
  ...
  upNextEvent: { color: '#AEB8C0', fontFamily: fonts.bold, fontSize: 11, lineHeight: 14, letterSpacing: .35, textAlign: 'center', textShadowColor: 'rgba(0,0,0,.95)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 4 },
  ...
  seasonContext: { marginTop: 2, color: '#909BA5', fontFamily: fonts.bold, fontSize: 11, lineHeight: 14, letterSpacing: .25 },
  seasonMetric: { width: 78, flexShrink: 0, alignItems: 'flex-end', justifyContent: 'center' },
  seasonMetricLabel: { color: '#929DA7', fontFamily: fonts.bold, fontSize: 11, lineHeight: 14, letterSpacing: .35 },
