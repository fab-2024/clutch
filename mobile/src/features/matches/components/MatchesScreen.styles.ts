...
export const styles = StyleSheet.create({
  ...
  daysRow: { zIndex: 2, marginTop: 'auto', flexDirection: 'row', gap: 5 },
  dayButton: { flex: 1, minWidth: 0, height: 48, borderRadius: 15, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(234,244,216,.14)', borderWidth: 1, borderColor: 'rgba(255,255,255,.09)' },
