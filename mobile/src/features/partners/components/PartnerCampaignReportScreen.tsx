...
const styles = StyleSheet.create({
  ...
  backButton: { minHeight: 47, paddingHorizontal: 17, alignItems: 'center', justifyContent: 'center', borderRadius: 14, backgroundColor: '#111A22' },
  ...
  headerBack: { minHeight: 42, paddingHorizontal: 11, alignItems: 'center', justifyContent: 'center', borderRadius: 13, backgroundColor: '#0B1218', borderWidth: 1, borderColor: '#302A42' },
  ...
  modeTabs: { minHeight: 57, marginHorizontal: spacing.md, padding: 5, flexDirection: 'row', gap: 5, borderRadius: 18, backgroundColor: '#0B1218', borderWidth: 1, borderColor: '#26232E' },
  ...
  metricCard: { width: '48%', minHeight: 137, padding: 14, borderRadius: 21, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#292632' },
  ...
  funnel: { marginHorizontal: spacing.md, padding: 16, gap: 14, borderRadius: 24, backgroundColor: '#0B1218', borderWidth: 1, borderColor: '#292632' },
  funnelRow: { gap: 7 },
  ...
  privacyCard: { marginHorizontal: spacing.md, padding: 16, borderRadius: 24, backgroundColor: '#0B1218', borderWidth: 1, borderColor: '#292632' },
