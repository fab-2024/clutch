...
export const styles = StyleSheet.create({
  ...
  scheduleHero: { position: 'relative', minHeight: 158, marginHorizontal: spacing.md, overflow: 'hidden', borderRadius: 23, backgroundColor: '#101820', borderWidth: 1, borderColor: '#2B3540', padding: 12, paddingBottom: 20 },
  ...
  statusSwitch: { flex: 1, minHeight: 50, padding: 3, borderRadius: 14, flexDirection: 'row', backgroundColor: '#070B0F', borderWidth: 1, borderColor: '#202832' },
  ...
  skeletonList: { overflow: 'hidden', borderRadius: 20, backgroundColor: '#0B1015', borderWidth: 1, borderColor: '#222B34' },
