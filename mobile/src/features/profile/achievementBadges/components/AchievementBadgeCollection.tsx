...
const styles = StyleSheet.create({
  root: { gap: 14 },
  summary: { minHeight: 74, marginHorizontal: spacing.md, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10, borderRadius: 21, backgroundColor: '#0A0F14', borderWidth: 1, borderColor: '#28323B' },
