...
const styles = StyleSheet.create({
  ...
  progressBar: { width: 27, height: 3, borderRadius: 3, backgroundColor: '#152633' },
  ...
  gamesGrid: { gap: 10 },
  gameCard: { position: 'relative', minHeight: 126, overflow: 'hidden', flexDirection: 'row', alignItems: 'center', gap: 13, padding: 13, borderRadius: 21, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E' },
  ...
  check: { width: 30, height: 30, zIndex: 1, borderRadius: 15, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#30414E', backgroundColor: 'rgba(5,8,11,.68)' },
  ...
  teamCard: { position: 'relative', width: '31.6%', minHeight: 146, overflow: 'hidden', alignItems: 'center', padding: 10, borderRadius: 19, backgroundColor: '#111A22', borderWidth: 1, borderColor: '#30414E' },
  ...
  gameDot: { width: 5, height: 5, borderRadius: 3, backgroundColor: '#152633' },
